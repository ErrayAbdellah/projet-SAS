...
typedef struct Produit 
	...
	void ListerProduitNom(produit T[])
	{
		produit tmp;
	...
	///***********************************************
	void ListerProduitPrix(produit T[])
	{
		produit tmp;
	...
	float AcheterProduit(produit T[])
	{
		cass:
			int code,qnt;
			int index = -1;
	...
	void RechercherProduits(produit T[] ,int a)
	{
		int code;
		int index = -1;
